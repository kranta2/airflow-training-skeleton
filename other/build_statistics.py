...
spark.read.json(
    "gs://airflow_training_kranta/land_registry_price_paid_uk/*/*.json"
).withColumn(
...
spark.read.json("gs://airflow_training_kranta/currency/*.json").withColumn(
...
(
    ...
    .parquet("gs://airflow_training_kranta/average_prices/")
)
